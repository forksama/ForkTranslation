...
function setBusy(busy) {
  state.busy = busy;
  $("chooseMappingButton").disabled = busy;
  $("chooseWorkdirButton").disabled = busy;
  $("choosePortraitDirButton").disabled = busy;
...
function readOptions() {
  return {
    audioTrackSpec: $("audioTrackSpec").value.trim() || "A1",
    videoTrackSpec: $("videoTrackSpec").value.trim() || "new"
  };
}
